<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
    <h2 style="color: #333;">{{ __('Password Reset Request') }}</h2>
    
    <p style="font-size: 16px; color: #555; line-height: 1.5;">
        {{ __('You are receiving this email because we received a password reset request for your account at') }} <strong>{{ $tenantName }}</strong>.
    </p>
