            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-md-5">
                    <div class="text-center mb-4">
                        ...
                        <h1 class="h4 fw-bold">{{ __('Reset Password') }}</h1>
                        <p class="text-muted small">{{ __('Please enter your new password below.') }}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('platform.password.update') }}">
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-label fw-semibold small text-uppercase tracking-wider">{{ __('New Password') }}</label>
                        ...
                        <div class="mb-4">
                            <label for="password-confirm" class="form-label fw-semibold small text-uppercase tracking-wider">{{ __('Confirm New Password') }}</label>
