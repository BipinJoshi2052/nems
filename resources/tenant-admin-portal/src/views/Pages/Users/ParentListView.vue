<template>
  <MainLayout>
    <div class="p-4 md:p-6">
      <PageBreadcrumb pageTitle="Parent Directory" />

      <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">Parent Directory</h2>
        <p class="text-sm text-gray-500">Manage parent accounts, linked students, and communication.</p>
      </div>
